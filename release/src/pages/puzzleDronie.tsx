...
const FILES = [
    ...
    "F3: Melody urges you to ignore the red herring.",
    ...
    "",
...
const DEVHELP = [
    ...
    ("RF#: Read data file #. RF0-RF4"),
    ("H2A: Converts the input hex file to human readable ASCII. H2A" + TERMINALSPLIT + "RF#"),
    ("MINT: Mints the elusive Red Herring"),
